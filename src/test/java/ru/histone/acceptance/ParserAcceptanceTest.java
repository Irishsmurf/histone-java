...
public class ParserAcceptanceTest extends Runner {
    ...
    public void run(RunNotifier notifier) {
        ...
        parser = new Parser(tokenizerFactory, nodeFactory);
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                reader = new InputStreamReader(getClass().getResourceAsStream("/parser/" + element.asText()));
    ...
    private void runTestCase(RunNotifier notifier, String input, String expected, String[] exception) {
        ...
        try {
            JsonNode expectedJson = (expected == null) ? jackson.getNodeFactory().nullNode() : jackson.readTree(expected);
            ...
            if ((exception != null) && (exception.length > 0)) {
                ...
                boolean result = outputJson.toString().equals(expectedJson.toString());
