 ...
 */
public class NumberNodeUserFunction_A extends NodeFunction<NumberHistoneNode>{
    public NumberNodeUserFunction_A(NodeFactory nodeFactory) {
        super(nodeFactory);
    }
    ...
    public Node execute(NumberHistoneNode target, Node... args) throws NodeFunctionExecutionException {
        return getNodeFactory().string("number_a_result");
    }
}
