...
public final class HistoneTokensHolder {
    private static final List<TokenDef> tokens = Collections.unmodifiableList(new ArrayList<TokenDef> (){{
        ...
        add(new TokenDef(TokenType.T_BLOCK_START, TokenKind.TOKEN, TokenContext.TEMPLATE, TokenContext.EXPRESSION, "\\Q{{\\E"));
        add(new TokenDef(TokenType.T_BLOCK_END, TokenKind.TOKEN, TokenContext.EXPRESSION, TokenContext.TEMPLATE, "\\Q}}\\E"));
